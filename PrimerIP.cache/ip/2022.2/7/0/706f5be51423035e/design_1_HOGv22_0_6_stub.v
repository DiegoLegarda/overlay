...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ACLK, ARESETN, out_contador, out_average, 
  out_bloque, out_start_bin, out_final_process, out_ready_histo, out_soma, out_celda, 
...
/* synthesis syn_black_box black_box_pad_pin="ACLK,ARESETN,out_contador[14:0],out_average[15:0],out_bloque[3:0],out_start_bin,out_final_process,out_ready_histo,out_soma[24:0],out_celda[3:0],s00_axis_tready,s00_axis_tdata[31:0],s00_axis_tstrb[3:0],s00_axis_tlast,s00_axis_tvalid,m00_axis_tvalid,m00_axis_tdata[31:0],m00_axis_tstrb[3:0],m00_axis_tlast,m00_axis_tready" */;
  input ACLK;
  input ARESETN;
